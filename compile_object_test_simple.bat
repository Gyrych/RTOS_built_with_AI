...
set LDFLAGS=-mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -Wl,--gc-sections -nostartfiles -nostdlib
...
if exist object_test.elf (
    ...
    echo.
    echo 显示程序大小信息...
    arm-none-eabi-size object_test.elf
    echo.
